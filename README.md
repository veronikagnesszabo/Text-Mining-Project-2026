...
For now we have chosen EmoBank as a traing/evaluation data set for the Ted Talk dataset. However, we would like to further explore other options within the first week of the project by looking at past research and searching the web. The EmoBank data set has been chosen as a preliminary dataset as it contains both emotional tags of intented emotions of the writer and the perceived emotions of the readers which we though would be useful for the second and third research question. 

## A tentative list of milestones for the project
**Delegation of tasks for week 1:**

20th April — Project Kickoff & Data Exploration
...
| Veronika | Research and compare VADER vs TextBlob vs NRC Lexicon, write a short summary of chosen approach for the group |
| Elijus | Set up shared GitHub repo, create folder structure, research 2–3 similar text mining projects for inspiration |

Group Milestone: Everyone has the dataset loaded locally, shared repo is live, and tool choices are agreed upon
